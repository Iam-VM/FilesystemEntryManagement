...
int main(int argc, char* argv[])
{
  ...
  main_desc.add_options()
    ...
    ("src, s", po::value<std::vector<fs::path>>()->multitoken(), "to specify paths of source entries[entries can be files/directories/symlinks !!]")
    ("target, t", po::value<std::vector<fs::path>>()->multitoken(), "to specify paths of the targets");
  ...
  int return_code = main_utils_interface(options_map, main_desc);
